...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbku.execSQL("create table if not exists kontak(nama TEXT, nohp TEXT, mk TEXT);");
        ambildata();
    }
...
//
    private void add_item(String nm, String hp, String mk) {
...
//        kontak newKontak = new kontak(nm, hp,mk,tugas,quiz,ets,eas);
        kontak newKontak = new kontak(nm, hp, mk);
        kAdapter.add(newKontak);

    }
//
    private void insertKontak(String nm, String hp, String mk) {
//        kontak newKontak = new kontak(nm, hp, mk, tugas, quiz, ets, eas);
        kontak newKontak = new kontak(nm, hp, mk);
        kAdapter.add(newKontak);
    }
